...
AtRule.prototype.processChildren = function(parent, location) {
  var self = this;
...
AtRule.prototype.processSelf = function(parentSelectors, location) {
  var self = this;
  var children = Rule.prototype.processSelf.call(this, parentSelectors, location);
...
AtRule.prototype.process = function(parentSelectors, location) {
  var self = this;
  parentSelectors = parentSelectors || [];
  return self.processSelf(parentSelectors, location) + '\n' + self.processChildren(parentSelectors, location);
};
